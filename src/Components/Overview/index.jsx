    ...
    return (
      <section className="bg-white py-12 px-6 md:px-16 text-gray-700">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          {/* Who Are We */}
          <div>
            <h2 className="text-3xl text-black md:text-4xl font-abril font-extrabold mb-2">Who Are We?</h2>
          ...
          {/* Know Our Numbers */}
          <div>
            <h2 className="text-3xl text-black  md:text-4xl font-abril font-extrabold mb-2">Know Our Numbers.</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <div>
            <h2 className="text-3xl text-black  md:text-4xl font-abril font-extrabold mb-2">Student Management Portal</h2>
            <p className="text-base md:text-lg mb-4">
            ...
            <Link
            to="/portal"
            className="inline-block bg-[#800020] text-white py-2 px-4 rounded-full mt-2 text-sm font-abril font-semibold hover:bg-[#5e0018]"
          >
            Find Out More &gt;
          </Link>
          </div>
